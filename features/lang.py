...
def main():
    ...
    if st.session_state.username:
       ...
       st.title(" Welcome to Language Learner ")
       st.markdown("""
### 📖 How to Use Language Learner 

**Getting Started:**
1. Enter your username from  the left  sidebar and select your target language
2. Choose your skill level: Beginner, Intermediate, or Advanced

**Quick Navigation:**
- **📚 Learn**: Get language info, translate text, and practice common phrases
- **🔤 Vocabulary**: Study word categories with flashcards or list view
- **🎯 Practice**: Engage in conversations with Listen & Repeat, Memory, or Role Play modes
- **🎮 Quiz**: Test your knowledge with customizable vocabulary quizzes
- **🗣️ Pronunciation**: Practice words, sentences, and tongue twisters with audio
- **🧠 Grammar**: Learn rules and complete interactive exercises
- **📊 Progress**: Track your learning stats and get personalized recommendations

Start with the **Learn** tab to understand your chosen language, then explore other features based on your learning goals!
""")
